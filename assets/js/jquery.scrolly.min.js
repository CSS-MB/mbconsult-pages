...
(function (e) {
  function a(e) {
    var t;
    if ("string" != typeof e || "#" != e.charAt(0) || e.length < 2) return n;
    try {
  ...
  function u(s, o) {
    var u, f, l, c;
    if ((l = a(s)) === n || (u = e(l))[t] == 0) return n;
    f = u[i]()[r];
    switch (o.anchor) {
      case "middle":
        c = f - (e(window).height() - u.outerHeight()) / 2;
        break;
      default:
      case r:
        c = Math.max(f, 0);
    }
    return typeof o[i] == "function" ? (c -= o[i]()) : (c -= o[i]), c;
  }
  var t = "length",
    n = null,
    r = "top",
